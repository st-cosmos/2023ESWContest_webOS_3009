...
import com.example.healthsync.presentation.component.ExerciseSessionRow
 ...
 */
@Composable
fun DataSyncSelectScreen(
    permissions: Set<String>,
    permissionsGranted: Boolean,
    sessionsList: List<ExerciseSessionRecord>,
    uiState: DataSyncSelectViewModel.UiState,
    onInsertClick: () -> Unit = {},
    ...
    LaunchedEffect(uiState) {
        ...
        if (uiState is DataSyncSelectViewModel.UiState.Uninitialized) {
            onPermissionsResult()
        }
        ...
        if (uiState is DataSyncSelectViewModel.UiState.Error && errorId.value != uiState.uuid) {
            onError(uiState.exception)
            errorId.value = uiState.uuid
        }
    }

    if (uiState != DataSyncSelectViewModel.UiState.Uninitialized) {
        LazyColumn(
...
@Preview
@Composable
fun DataSyncSelectScreenPreview() {
    HealthConnectTheme {
        ...
        DataSyncSelectScreen(
            ...
            uiState = DataSyncSelectViewModel.UiState.Done
        )
    }
}
